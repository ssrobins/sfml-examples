...
int main()
{
    ...
    for(int i=0;i<15;i++)
    {
        ...
        a->settings(sRock, rand()%W, rand()%H, static_cast<float>(rand()%360), 25);
    ...
    while (app.isOpen())
    {
                ...
                if (a->name=="asteroid" && b->name=="bullet")
                {
                    if ( isCollide(a,b) )
                    {
                        ...
                        for(int i=0;i<2;i++)
                        {
                            ...
                            e->settings(sRock_small, static_cast<int>(a->x), static_cast<int>(a->y), static_cast<float>(rand()%360), 15);
                            entities.push_back(e);
                        }
        ...
        {
            asteroid *a = new asteroid();
            a->settings(sRock, 0,rand()%H, static_cast<float>(rand()%360), 25);
            entities.push_back(a);
        }
